...
Usage:
    python3 -m sender.hand.calibrate --sdk-path sender/hand/sdk/SDKClient_Linux/SDKClient_Linux.out
    python3 -m sender.hand.calibrate --output calibration_right.json --hand right
"""
