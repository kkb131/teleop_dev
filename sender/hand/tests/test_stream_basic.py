...
Usage:
    python3 -m sender.hand.tests.test_stream_basic
    python3 -m sender.hand.tests.test_stream_basic --sdk-path sender/hand/sdk/SDKClient_Linux/SDKClient_Linux.out
    python3 -m sender.hand.tests.test_stream_basic --duration 10
"""
