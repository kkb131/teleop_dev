...
Usage:
    ...
    # With real glove:
    python3 -m sender.hand.tests.test_step4_udp --real --sdk-path sender/hand/sdk/libManusSDK.so
"""
...
from sender.hand.manus_reader import HandData, NUM_JOINTS, NUM_FINGERS
...
def _summary(passed, failed):
    ...
    if failed == 0:
        ...
        print("  Next: python3 -m sender.hand.manus_sender --target-ip <ROBOT_IP>")
    else:
