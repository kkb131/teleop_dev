...
Usage:
    python3 -m sender.arm.keyboard_sender --target-ip <ROBOT_PC_IP>
    python3 -m sender.arm.keyboard_sender --target-ip 192.168.0.10 --hz 50
"""
...
from sender.arm.sender_base import InputResult, TeleopSenderBase
